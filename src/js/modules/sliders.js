...
function quizSwiper() {
    new Swiper('[data-swiper="slider__test"]', {
        ...
        effect: 'fade',
        navigation: {
            nextEl: getElement('.next__test', getElement('[data-swiper="slider__test"]')),
            prevEl: getElement('.prev__test', getElement('[data-swiper="slider__test"]')),
        },
...
export {promoSlider, doctors, ourHospital, hotel, beforeAfter, quizSwiper, patientSlider}
